"""
UAgriAIV Backend — FastAPI Application
TV4: Software Lead
...
app = FastAPI(
    title       = "UAgriAIV API",
    description = "Backend API cho hệ thống UAV × AI phát hiện bệnh cây trồng",
    version     = "1.0.0",
    lifespan    = lifespan,
)
...
async def health():
    return {"status": "ok", "service": "uagriaiv-backend", "version": "1.0.0"}
